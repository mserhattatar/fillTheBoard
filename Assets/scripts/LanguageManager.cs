...
public class LanguageManager : MonoBehaviour
{
    public Dictionary<string, string> enTextDict = new Dictionary<string, string> {
        ...
        { "RetryGameInfo", "Retry current game from starting first level. You will lose current game data except best score" },
    ...
    public Dictionary<string, string> trTextDict = new Dictionary<string, string> {
        { "CreatingBy", "BU OYUN FunTactic GAME TARAFINDAN OLUŞTURULMUŞTUR" },
        { "IBackButton", "Geri" },       
        ...
        { "RetryLevel", "LEVELI YENİLE" },
        { "RetryGame", "OYUNU YENİLE" },
        { "StepBack", "GERİ AL" },
        { "BestScore", "En iyi Skor" },
        { "BestLevel", "Skor Levelı" },
        { "NextLevel", "SONRAKİ LEVEL" },
        { "YouWin", "LEVELI BİTİR VE OYUNU KAZAN!" },
        ...
        { "Leaveasless", "Olabildiğince az boş kutu bırak çünkü doldurulmamış kutular sonraki levela bloklanmiş olarak aktarılacak." },
        { "RetryGameInfo", "İlk levelden başlayarak seçili oyunu yeniden dene. En iyi skor hariç bu oyuna ait verilerini kaybedeceksin." },
        { "RetryLevelInfo", "Leveli istedigin kadar yeniden dene. Bu butonu özellikle daha iyi bir level sonu başarısı istiyorsan yada level başında bloklanmış kutuların pozisyonunu değiştirmek istiyorsan kullanabilirsin." },
        { "IStepBackText", "Bir adim geri git ve tekrar dene. Her levelde 1 adet geri gitme hakkin var ve eger kullanmazsan bu hakkin kayıp olacak." },
        { "IDontForgetText", "Unutma! Her levelde en fazla 20 doldurulmamış* kutu birakabilirsin. Yoksa yeterli sayıda kutu doldurana kadar levelı tekrarlaman gerekecek :)" },                
